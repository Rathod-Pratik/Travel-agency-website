...
export const bookingCancelledByUserEmail = (
    ...
    return `
        ...
        <head>
            ...
            <title>Booking Cancelled - TravelWorld</title>
        ...
        <body>
            ...
            : ""
                    ...
                    <p>
                        ${data.payment
            ? "If your booking is eligible for a refund, the refund will be processed according to our cancellation policy."
            : ""
        }
                    </p>
                    ...
                    <p>
                        We hope to see you travelling with us again soon. 🌍✈️
                    </p>
