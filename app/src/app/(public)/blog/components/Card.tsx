     ...
     <div>
      ...
      <div className="mt-2 p-2">
        ...
        <div className="flex flex-row justify-between items-center text-gray-500">
          <Link href={`${'/blogdetails'}?_id=${data._id}`} className="text-sm cursor-pointer text-center font-semibold rounded-md bg-[orange] text-white py-1 px-1 hover:bg-orange-600 transition-colors">
            Read More
          </Link>
        </div>
      </div>
